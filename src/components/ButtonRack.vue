...
@Component
export default class ButtonRack extends Vue {
  @Prop() private buttons?: object;
  @Prop() private classes?: string;
  @Prop() private bnclass?: string;
  @Prop() private screen?: boolean;
  @Prop() private linkLabel?: string;
