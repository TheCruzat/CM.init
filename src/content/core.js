...
const cc = {
	...
	services: {
		...
		recording: {
			title: 'Audio Recording',
			content: '<img class="bigshot edge f-right" src="'+team+'" alt="Audio Recording"><h2 class="topper">// The Uniqueness of You</h2><p>Sound is such an immediate and intimate sense. If at a performance, it\'s all about the sound, the experience of sharing it. In a room with speakers, the sound becomes a presence, sharing your space. If listening to headphones, the sound is literally in your head. The original augmented reality experience was walking down the street listening to a Walkman.</p><p>Such a versatile and flexible medium, with such a simple foundation: plug something into an input, then play something or say something. And from there it can go in so many directions, from recording a podcast to restoring damaged audio to tracking in your next amazing song.</p><h2 class="topper">// Nothing Like a Good Chat</h2><p>In the past five years, podcasts have exploded in popularity, speaking to a market that continues to gain definition. Interviews, documentary, commentary and original fiction; if you listen to podcasts, chances are you have an idea for a show that could fit into one of those categories.</p><p>We can help you with this. Cruzat.Media has mobile recording capabilities for up to four separate channels (microphones) of audio, perfect for a small round table discussion. We can catch it, clean it and cook it, your show will sound good.</p><div class="centro"><div class="bumper"></div><h2 class="topper">// Voices from the Past</h2><p>This is the digital age, it\'s as easy as picking up your phone to capture a golden moment. In previous eras, it was usually an enterprising youngster in the family, interviewing elders with a tape recorder and a microphone.</p><p>If you were that youngster, maybe even still have the box of tapes tucked away somewhere, it is important to transfer those tapes if you have not already done so. Every decade that magnetic tape ages, it becomes more brittle. Cruzat.Media can assist with both the transfer and restoration of these irreplaceable conversations.</p><h2 class="topper">// Rawkin Out</h2><p>And then there are the good old fashioned labrats, studio dwellers who create environments and songs in their own little nests -- Dan is one of you. There are some killer demos you\'ve made but you know there is room for improvement.</p><p>If you love outboard gear, taking it all to a by-the-hour studio can be a daunting task. And costly -- time ticks away while you connect and break down cables. Cruzat.Media can bring a mobile recording solution directly to you, capture the sound of your gear in its native environment.</p><div class="bumper"></div><h2 class="topper">// Let\'s Get Busy</h2><p>Whether you are recording a podcast or a song, if you need sound design or production, Cruzat.Media can help. Contact us today with how things are sounding for you today, we will help you dial it in.</p></div>',
			icon: 'fa-microphone',
			route: '/services/audio-recording',
			loc: 'serv\\rec',
			titleNav: [
